...
-->
						...
						<?php if ($mobile != "") { ?>
    <li><span>手機 :</span> <a href="tel:<?php echo $mobile; ?>"><?php echo $mobile; ?></a></li>
<?php } ?>
<?php if ($mobile2 != "") { ?>
    <li><span>手機 :</span> <a href="tel:<?php echo $mobile2; ?>"><?php echo $mobile2; ?></a></li>
<?php } ?>
<!--
<?php if ($mobile3 != "") { ?>
...
-->
<?php if ($work_tel != "") { ?>
    <li><span>電話 :</span> <a href="tel:<?php echo $work_tel; ?>"><?php echo $work_tel; ?></a></li>
<?php } ?>
<?php if ($work_tel2 != "") { ?>
    <li><span>電話 :</span> <a href="tel:<?php echo $work_tel2; ?>"><?php echo $work_tel2; ?></a></li>
<?php } ?>
<!--
<?php if ($work_tel3 != "") { ?>
...
-->
                            ...
                            <?php if ($work_email != "") { ?>
    <li><span>電郵 :</span> <a href="mailto:<?php echo $work_email; ?>"><?php echo $work_email; ?></a></li>
<?php } ?>
<?php if ($work_email2 != "") { ?>
    <li><span>電郵 :</span> <a href="mailto:<?php echo $work_email2; ?>"><?php echo $work_email2; ?></a></li>
<?php } ?>
<!--
<?php if ($work_email3 != "") { ?>
...
-->
                            ...
                            <?php if ($fax!=""){ ?>
                            <li><span>傳真 :</span> <?php echo $fax; ?></li>
							<?php } ?>
							<?php if ($wechat_id!=""){ ?>
							...
							<?php } ?>
                            <?php if ($address2!=""){ ?>
                            <li><span>地址 :</span> <?php echo "$address2" ; ?></li>
							<?php } ?>
                            <?php if ($web_link!=""){ ?>
                            <li><span><?php echo $web_link_label;?>:</span> <a href="<?php echo "$web_link" ; ?>" target="_blank"><?php echo $web_link; ?></a></li>
							<?php } ?>
