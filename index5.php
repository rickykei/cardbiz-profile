...
<link rel="stylesheet" href="/vcard/icon-fonts/font-awesome-6.3.0/css/all.min.css"/>
    <link rel="stylesheet" href="/vcard/icon-fonts/font-awesome-6.3.0/css/brands.css"/>
	...
	<div class="container wrapper">
    	<div class="site">
                    	<div class="left-navbar">
							...
							<?php } else { ?>
							<img class="signature" src="/assets/img/logo/white_logo.jpg" alt="" width="40">
							<?php } ?>
							</a>
...
<?php } ?>
							...
							<?php } ?>
                             <?php if ($work_email != "") { ?>
    <li><span><?php echo $work_email_label;?> 電郵 :</span> <a href="mailto:<?php echo $work_email; ?>"><?php echo $work_email; ?></a></li>
<?php } ?>
<?php if ($work_email2 != "") { ?>
    <li><span><?php echo $work_email2_label;?> 電郵 :</span> <a href="mailto:<?php echo $work_email2; ?>"><?php echo $work_email2; ?></a></li>
<?php } ?>
<?php if ($work_email3 != "") { ?>
    <li><span><?php echo $work_email3_label;?> 電郵 :</span> <a href="mailto:<?php echo $work_email3; ?>"><?php echo $work_email3; ?></a></li>
<?php } ?>
<?php if ($home_email != "") { ?>
    <li><span><?php echo $home_email_label;?> 電郵 :</span> <a href="mailto:<?php echo $home_email; ?>"><?php echo $home_email; ?></a></li>
<?php } ?>
<?php if ($other_email != "") { ?>
    <li><span><?php echo $other_email_label;?> 電郵 :</span> <a href="mailto:<?php echo $other_email; ?>"><?php echo $other_email; ?></a></li>
<?php } ?>
							<?php if ($wechat_id!=""){ ?>
                            <li><span>微訊號 :</span> <?php echo $wechat_id; ?></li>                            
							<?php } ?>
                             <?php if ($address!=""){ ?>
						...
						<?php } ?>
                        <br><br>
                         <a class="recoba-btn" target="_blank" href="<?php echo $savemycontact; ?>">保存聯絡人</a>
<!-- 
