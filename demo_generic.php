...
$newClass = new GenericClass([
    ...
    $response = $this->service->genericclass->update("{$issuerId}.{$classSuffix}", $newClass);
  ...
  public function createObject(string $issuerId, string $classSuffix, string $objectSuffix)
  {
    ...
    $newObject = new GenericObject([
      ...
      'barcode' => new Barcode([
        'type' => 'QR_CODE',
        'value' => 'https://e-profile.digital/?key=U2FsdGVkX1%2FuRVD%2BnxIjl2aH56rpgMfcj9DmTVrpWpN6TlGpp3MdtyXJ93nE5yta&bo=1'
      ]),
 ...
 $newObject = new GenericObject([
  ...
  //  echo "Add to Google Wallet link\n";
	//echo "<br>";
    //$aa="https://pay.google.com/gp/v/save/{$token}";
	//echo "<a href=".$aa." target='_blank'> click here to wallet";
