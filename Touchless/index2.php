...
<!-- Font icons -->
<link rel="stylesheet" href="../Touchless/vcard/icon-fonts/font-awesome-6.3.0/css/all.min.css"/>
	...
	<div class="container wrapper">
    	<div class="site">
                    	<div class="left-navbar">
                        	...
                        	<a  class="" href="">
							<?php if($company_logo!=""){ ?>
							<img class="signature" src="https://uat.profiles.digital/api/files/<?php echo $company_logo;?>" alt="" width="50">
							<?php } else { ?>
							<img class="signature" src="https://uat.profiles.digital/assets/img/logo/white_logo.jpg" alt="" width="50">
							<?php } ?>
							</a>
                    ...
                    <div class="floor contact">
                        ...
                        <br><br>
                         ...
                         <a class="recoba-btn" href="https://uat.profiles.digital/genvcf.php?sig=<?php echo $sig;?>">Click Here</a>
                    </div>
