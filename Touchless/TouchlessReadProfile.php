...
if (isset($_GET['sig'])){   
    if (strlen($_GET['sig'])==10){       
       ...
       $sig_check_query = "SELECT name,website,url,brochure,facebook,linkedin,whatsapp,wechat,instagram,twitter,youtude FROM Vcard WHERE signature='$signature' LIMIT 1";
