...
-->
						...
						<?php if ($mobile != "") { ?>
    <li><span>手机 :</span> <a href="tel:<?php echo $mobile; ?>"><?php echo $mobile; ?></a></li>
<?php } ?>
<?php if ($mobile2 != "") { ?>
    <li><span>手机 :</span> <a href="tel:<?php echo $mobile2; ?>"><?php echo $mobile2; ?></a></li>
<?php } ?>
<!--
<?php if ($mobile3 != "") { ?>
...
-->
<?php if ($work_tel != "") { ?>
    <li><span>电话 :</span> <a href="tel:<?php echo $work_tel; ?>"><?php echo $work_tel; ?></a></li>
<?php } ?>
<?php if ($work_tel2 != "") { ?>
    <li><span>电话 :</span> <a href="tel:<?php echo $work_tel2; ?>"><?php echo $work_tel2; ?></a></li>
<?php } ?>
<!--
<?php if ($work_tel3 != "") { ?>
...
-->
                            ...
                            <?php if ($work_email != "") { ?>
    <li><span>电邮 :</span> <a href="mailto:<?php echo $work_email; ?>"><?php echo $work_email; ?></a></li>
<?php } ?>
<?php if ($work_email2 != "") { ?>
    <li><span>电邮 :</span> <a href="mailto:<?php echo $work_email2; ?>"><?php echo $work_email2; ?></a></li>
<?php } ?>
<!--
<?php if ($work_email3 != "") { ?>
...
-->
                            ...
                            <?php if ($fax!=""){ ?>
                            <li><span>传真 :</span> <?php echo $fax; ?></li>
							<?php } ?>
							<?php if ($wechat_id!=""){ ?>
						...
						<?php } ?>
                        <br><br>
                         <a class="recoba-btn" target="_blank" href="<?php echo $savemycontact; ?>">保存联络人</a>
<!-- 
