    	...
    	<div class="site">
                    ...
                    <div class="scroll-out">
                        <div class="floor home-page">
                             <div class="home-box" style="font-family:Hando, Arial">
								...
								<?php } ?>
                                 <?php if ($type1_no!=""){ ?>
									&nbsp;&nbsp;&nbsp;Type 1: Dealing in Securities<br>&nbsp;&nbsp;&nbsp;第1類： 證券交易<br>
								<?php } ?>
                                <?php if ($type4_no!=""){ ?>
                                    &nbsp;&nbsp;&nbsp;Type 4: Advising on Securities<br>&nbsp;&nbsp;&nbsp;第4類： 就證券提供意見<br>
							<?php } ?>
                                <?php if ($type6_no!=""){ ?>
								&nbsp;&nbsp;&nbsp;Type 6: Advising on Corporate Finance<br>&nbsp;&nbsp;&nbsp;第6類： 就機構融資提供意見<br>
							<?php } ?>
                                <?php if ($type9_no!=""){ ?>
                            &nbsp;&nbsp;&nbsp;Type 9: Asset Management<br>&nbsp;&nbsp;&nbsp;第9類： 提供資產管理<br> 
							<?php } ?>
							...
							<?php } ?>
							 ...
							 <?php if ($field064!=""){ echo $field064; ?><br><?php }?>
							   ...
							   <?php if ($company_name_option!=""){ ?>
                                <h4 class="subtitle" style="color:grey;"><?php echo $company_name_option_eng[$company_name_option];?><br><?php echo $company_name_option_chi[$company_name_option];?></h4>
							   <?php } ?>
                    ...
                    <div class="contact-box" style="font-family:Hando, Arial">
						...
						<?php if ($work_tel!=""){ ?>
							...
							<?php } ?>
                            <?php if ($work_tel2!=""){ ?>
                            <li><span><i data-icon="R" class="features"></i></span> <?php echo $work_tel2; ?></li>
							<?php } ?>
                            <?php if ($work_tel3!=""){ ?>
                            <li><span><i data-icon="R" class="features"></i></span> <?php echo $work_tel3; ?></li>
							<?php } ?>
                            <?php if ($direct_tel!=""){ ?>
                            <li><span style="color:grey"><i data-icon="R" class="features" style="color:black"></i>&nbsp;Direct Line 直線</span> <?php echo $direct_tel; ?></li>
							<?php } ?>
                            
                            <?php if ($mobile!=""){ ?>
                            <li><span><i data-icon="0" class="features"></i></span> <?php echo $mobile; ?></li>
							<?php } ?>
                            <?php if ($mobile2!=""){ ?>
                            <li><span><i data-icon="0" class="features"></i></span> <?php echo $mobile2; ?></li>
							<?php } ?>
                            <?php if ($mobile3!=""){ ?>
                            <li><span><i data-icon="0" class="features"></i></span> <?php echo $mobile3; ?></li>
							<?php } ?>
                            <?php if ($mobile_china_tel!=""){ ?>
                            <li><span><i data-icon="0" class="features"></i></span> <?php echo $mobile_china_tel; ?></li>
							<?php } ?>
                            <?php if ($mobile_china_tel2!=""){ ?>
                            <li><span><i data-icon="0" class="features"></i></span> <?php echo $mobile_china_tel2; ?></li>
							<?php } ?>
                            <?php if ($mobile_china_tel3!=""){ ?>
                            <li><span><i data-icon="0" class="features"></i></span> <?php echo $mobile_china_tel3; ?></li>
							<?php } ?>
							 
                            <?php if ($field068!=""){ ?>
                            <li><span style="color:grey"><i data-icon="R" class="features" style="color:black"></i>&nbsp;Merchant Services Hotline 商戶服務熱線</span> <?php echo $field068; ?></li>
							<?php } ?>
                            
                            <?php if ($work_email!=""){ ?>
                            <li><span><i data-icon="A" class="icon"></i></span> <?php echo $work_email; ?></li>
							<?php } ?>
                            <?php if ($work_email2!=""){ ?>
                            <li><span><i data-icon="A" class="icon"></i></span> <?php echo $work_email2; ?></li>
							<?php } ?>
							<?php if ($work_email3!=""){ ?>
                            <li><span><i data-icon="A" class="icon"></i></span> <?php echo $work_email3; ?></li>
							<?php } ?>
                            <?php if ($fax!=""){ ?>
							...
							<?php } ?>
                            <?php if ($web_link2!=""){ ?>
                            <li><span><i data-icon="4" class="icon"></i></span> <?php echo $web_link2; ?></li>
							<?php } ?>
                            <?php if ($web_link3!=""){ ?>
                            <li><span><i data-icon="4" class="icon"></i></span> <?php echo $web_link3; ?></li>
							<?php } ?>
                            <?php if ($field067!=""){ ?>
